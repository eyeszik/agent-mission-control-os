...
// Optimization: Hoist static layout calculations and coordinate math derived solely
// from constants outside of the React component to avoid unnecessary memory allocation
// and garbage collection on every render.
