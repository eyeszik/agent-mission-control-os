...
// ⚡ Bolt Optimization: Hoist static layout calculations and coordinate math
// outside the component to prevent array allocation and garbage collection on every render.
