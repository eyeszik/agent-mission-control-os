...
// Optimization: Hoist static layout calculations and derived values
// outside the React component to avoid unnecessary memory allocation and garbage collection on every render.
