...
export function ApprovalInbox() {
  // Optimization: Compute derived state directly in the selector to prevent unnecessary re-renders
  // Returning a primitive (number) ensures the component only re-renders when the count changes
