...
export function ApprovalInbox() {
  // Compute primitive length directly in selector to avoid re-rendering
  // on every approvals record change when count remains the same.
  // Returning a primitive avoids useSyncExternalStore equality check issues.
