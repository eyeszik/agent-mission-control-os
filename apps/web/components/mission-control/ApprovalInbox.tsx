...
export function ApprovalInbox() {
  // ⚡ Bolt: Optimize by pushing filter and length calculation into the selector.
  // This prevents the component from re-rendering every time any approval changes,
  // re-rendering only when the pendingCount primitive changes.
