...
export function ApprovalInbox() {
  // ⚡ Bolt: Compute derived state directly in the selector to return a primitive (number).
  // This prevents unnecessary re-renders when the approvals object changes but pendingCount remains the same.
