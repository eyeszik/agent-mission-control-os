...
export function ApprovalInbox() {
  // Optimization: compute pendingCount directly in the selector to return a primitive
  // This prevents unnecessary re-renders when approvals change but the count remains the same
