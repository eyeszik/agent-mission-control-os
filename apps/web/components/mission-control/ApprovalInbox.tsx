...
export function ApprovalInbox() {
  // ⚡ Bolt: Compute pending count directly in the selector to return a primitive number,
  // preventing unnecessary re-renders that occur when returning new arrays like Object.values()
