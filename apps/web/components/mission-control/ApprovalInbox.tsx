...
export function ApprovalInbox() {
  // Optimization: Select only the derived pending count instead of the whole approvals record.
  // This prevents unnecessary re-renders when approvals are added/updated but the pending count remains the same.
