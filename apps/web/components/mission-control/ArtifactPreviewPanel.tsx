...
export function ArtifactPreviewPanel() {
  ...
  // Optimization: Compute derived state (like .find) inside the selector so the component
  // only re-renders when the selected artifact actually changes, avoiding re-renders when
  // other artifacts are added to the run's array.
