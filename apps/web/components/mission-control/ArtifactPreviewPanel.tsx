...
export function ArtifactPreviewPanel() {
  ...
  // ⚡ Bolt: Wrap derived array selector with useShallow to prevent unnecessary re-renders
  // when the underlying store changes but the filtered array content remains the same
